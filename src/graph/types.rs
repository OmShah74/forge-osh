...
impl Modifiers {
    ...
    pub fn is_public(self) -> bool {
        self.0 & mflags::IS_PUBLIC != 0
    }
    #[inline]
    pub fn is_async(self) -> bool {
        self.0 & mflags::IS_ASYNC != 0
    }
    #[inline]
    pub fn is_unsafe(self) -> bool {
        self.0 & mflags::IS_UNSAFE != 0
    }
    #[inline]
    pub fn is_static(self) -> bool {
        self.0 & mflags::IS_STATIC != 0
    }
    #[inline]
    pub fn is_mut(self) -> bool {
        self.0 & mflags::IS_MUT != 0
    }
    #[inline]
    pub fn is_const(self) -> bool {
        self.0 & mflags::IS_CONST != 0
    }
    #[inline]
    pub fn is_abstract(self) -> bool {
        self.0 & mflags::IS_ABSTRACT != 0
    }
    #[inline]
    pub fn is_override(self) -> bool {
        self.0 & mflags::IS_OVERRIDE != 0
    }
    #[inline]
    pub fn is_final(self) -> bool {
        self.0 & mflags::IS_FINAL != 0
    }
    #[inline]
    pub fn is_readonly(self) -> bool {
        self.0 & mflags::IS_READONLY != 0
    }
    #[inline]
    pub fn is_virtual(self) -> bool {
        self.0 & mflags::IS_VIRTUAL != 0
    }
    #[inline]
    pub fn is_native(self) -> bool {
        self.0 & mflags::IS_NATIVE != 0
    }
    #[inline]
...
impl CodeContent {
    ...
    pub fn stub(sig: impl Into<String>) -> Self {
        let s = sig.into();
        Self {
            token_weight: s.len() / 4 + 1,
            signature_only: s.clone(),
            full_snippet: s,
        }
    }
}
