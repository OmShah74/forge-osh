...
impl Theme {
    ...
    pub fn light() -> Self {
        Self {
            ...
            added_bg: Color::Rgb(220, 255, 220),
            removed_fg: Color::Rgb(160, 0, 0),
            removed_bg: Color::Rgb(255, 220, 220),
    ...
    pub fn solarized() -> Self {
        Self {
            ...
            added_fg: Color::Rgb(180, 210, 120),
            added_bg: Color::Rgb(15, 60, 30),
            removed_fg: Color::Rgb(240, 120, 120),
            removed_bg: Color::Rgb(70, 20, 20),
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            added_fg: Color::Rgb(180, 255, 180),
            added_bg: Color::Rgb(25, 60, 30),
            removed_fg: Color::Rgb(255, 180, 180),
            removed_bg: Color::Rgb(75, 20, 20),
    ...
    pub fn nord() -> Self {
        Self {
            ...
            added_fg: Color::Rgb(180, 220, 170),
            added_bg: Color::Rgb(30, 55, 35),
            removed_fg: Color::Rgb(220, 140, 150),
            removed_bg: Color::Rgb(65, 25, 30),
