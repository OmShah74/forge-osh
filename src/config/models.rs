...
pub fn anthropic_models() -> Vec<ModelInfo> {
    ...
    vec![
        ...
        // ── Claude 4.5/4.6/4.8 line (current) ──────────────────────────
        m(
            "claude-opus-4-8",
            "Claude Opus 4.8",
            200_000,
...
pub fn openai_models() -> Vec<ModelInfo> {
    vec![
        m(
            "gpt-4o", "GPT-4o", 128_000, true, true, 2.50, 10.0, "openai",
        ),
        m(
            "gpt-4o-2024-11-20",
            "GPT-4o (Nov 2024)",
        ...
        m(
            "o1-mini", "O1 Mini", 128_000, true, false, 3.0, 12.0, "openai",
        ),
        m(
            "o1-preview",
            "O1 Preview",
        ...
        m(
            "o3-mini", "O3 Mini", 200_000, true, false, 1.10, 4.40, "openai",
        ),
        m(
            "o4-mini", "O4 Mini", 200_000, true, true, 1.10, 4.40, "openai",
        ),
        m(
            "gpt-4.1", "GPT-4.1", 1_047_576, true, true, 2.0, 8.0, "openai",
        ),
        m(
            "gpt-4.1-mini",
            "GPT-4.1 Mini",
        ...
        // GPT-5 family. These models require `max_completion_tokens` (not
        // `max_tokens`) and reject custom `temperature` — handled in
        // OpenAICompatProvider::uses_max_completion_tokens / omits_temperature.
        m(
            "gpt-5",
            "GPT-5",
            400_000,
...
pub fn openrouter_models() -> Vec<ModelInfo> {
    vec![
        ...
        // ── DeepSeek (OpenRouter) ──────────────────────────────────────
        // deepseek-v4-pro pricing per the provider page: $0.7605 in /
        // $1.521 out per M (cache reads $0.063/M, applied via multipliers).
        ...
        // ── Other current frontier models via OpenRouter ───────────────
        m(
